...
def generate_paint_by_numbers(image, num_colors, static_folder="static"):
    ...
    svg += "<style>text{font-size:10px;fill:black;} path{stroke:black;stroke-width:0.5;fill:none;}</style>"
    ...
    # PNG-output: kleurvlakken ingevuld
